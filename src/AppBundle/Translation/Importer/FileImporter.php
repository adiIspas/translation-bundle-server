...
namespace AppBundle\Translation\Importer;

use AppBundle\Storage\StorageInterface;
use AppBundle\Manager\FileManagerInterface;
use AppBundle\Manager\TransUnitManagerInterface;
...
class FileImporter
{
    ...
    public function import(\Symfony\Component\Finder\SplFileInfo $file, $forceUpdate = false, $merge = false)
    {
        ...
        file_put_contents("loaders.txt", print_r($this->loaders,true));
        ...
        file_put_contents("import.txt", "Nr: " . $imported);
